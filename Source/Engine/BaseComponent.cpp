...
void BaseComponent::SetParent(BaseComponent *p) { parent = p; }

void BaseComponent::SetParentEID(EID id) { mManager->SetParent(mEntityID, id); }

BaseComponent *BaseComponent::GetParent() { return parent; }
