...
ComponentTest::ComponentTest(EID id, ComponentTestManager* manager) : BaseComponent(id, manager){
	updateCount = 0;
}
...
////////////////////////
ComponentTestManager::ComponentTestManager(EventDispatcher* e) : BaseComponentManager_Impl(e){
